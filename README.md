...
<blockquote>
  ...
  <ul>
  <li>Sublime and NetBeans shortcuts are not in the Linux Desktop folder yet, menulibre is installed to add it if desired, the icon is in ~/Documents/Programs/sublime_text_3/Icon and full command to start it is ~/Documents/Programs/sublime_text_3/sublime</li>
